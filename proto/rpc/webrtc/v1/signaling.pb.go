...
// ConnectionTransport is how a successful WebRTC connection was established. It is set only on
// success (reached_stage == READY).
type ConnectionTransport int32

const (
	ConnectionTransport_CONNECTION_TRANSPORT_UNSPECIFIED ConnectionTransport = 0
	// CONNECTION_TRANSPORT_CLOUD_SIGNALED: established via the cloud signaling server.
	ConnectionTransport_CONNECTION_TRANSPORT_CLOUD_SIGNALED ConnectionTransport = 1
	// CONNECTION_TRANSPORT_MDNS_LOCAL: established over a local-network, mDNS-discovered path.
...
var file_proto_rpc_webrtc_v1_signaling_proto_rawDesc = []byte{
	...
	0x10, 0x05, 0x2a, 0x89, 0x01, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x54, 0x5f, 0x4d, 0x44, 0x4e, 0x53, 0x5f, 0x4c, 0x4f, 0x43, 0x41, 0x4c, 0x10, 0x02, 0x32, 0xc3,
