...
const (
	...
	ICECandidateType_ICE_CANDIDATE_TYPE_RELAY ICECandidateType = 3
)
...
// earlier value is the stage at which a failed dial stopped. The dialing SDK tracks this exactly as
// it advances through the dial, so it is not inferred after the fact.
type DialStage int32

const (
	DialStage_DIAL_STAGE_UNSPECIFIED DialStage = 0
	// DIAL_STAGE_SIGNALING_CONNECTED: the signaling channel was established.
	DialStage_DIAL_STAGE_SIGNALING_CONNECTED DialStage = 1
	// DIAL_STAGE_CONFIG_FETCHED: ICE/TURN configuration was fetched from the signaling server.
	DialStage_DIAL_STAGE_CONFIG_FETCHED DialStage = 2
	// DIAL_STAGE_OFFER_SENT: the SDP offer was sent to the signaling server (the Call was accepted).
	// A failure here means the offer/Call itself failed; ANSWER_RECEIVED means the answerer replied.
	DialStage_DIAL_STAGE_OFFER_SENT DialStage = 3
	// DIAL_STAGE_ANSWER_RECEIVED: the answerer's SDP answer was received and applied.
	DialStage_DIAL_STAGE_ANSWER_RECEIVED DialStage = 4
	// DIAL_STAGE_ICE_CONNECTED: ICE connectivity was established (a candidate pair connected).
	DialStage_DIAL_STAGE_ICE_CONNECTED DialStage = 5
	// DIAL_STAGE_DTLS_CONNECTED: the DTLS handshake completed (peer connection connected) but the
	// data channel is not yet open. Separates DTLS/cert failures from data-channel failures.
	DialStage_DIAL_STAGE_DTLS_CONNECTED DialStage = 6
	// DIAL_STAGE_READY: the connection is fully ready (data channel open). This is success.
	DialStage_DIAL_STAGE_READY DialStage = 7
)

// Enum value maps for DialStage.
var (
	DialStage_name = map[int32]string{
		0: "DIAL_STAGE_UNSPECIFIED",
		1: "DIAL_STAGE_SIGNALING_CONNECTED",
		2: "DIAL_STAGE_CONFIG_FETCHED",
		3: "DIAL_STAGE_OFFER_SENT",
		4: "DIAL_STAGE_ANSWER_RECEIVED",
		5: "DIAL_STAGE_ICE_CONNECTED",
		6: "DIAL_STAGE_DTLS_CONNECTED",
		7: "DIAL_STAGE_READY",
	}
	DialStage_value = map[string]int32{
...
func (x DialStage) Enum() *DialStage {
	p := new(DialStage)
	*p = x
	return p
}

func (x DialStage) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DialStage) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_rpc_webrtc_v1_signaling_proto_enumTypes[2].Descriptor()
}

func (DialStage) Type() protoreflect.EnumType {
	return &file_proto_rpc_webrtc_v1_signaling_proto_enumTypes[2]
}

func (x DialStage) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DialStage.Descriptor instead.
func (DialStage) EnumDescriptor() ([]byte, []int) {
	return file_proto_rpc_webrtc_v1_signaling_proto_rawDescGZIP(), []int{2}
}

// ConnectionTransport is how a successful WebRTC connection was signaled, derived from the
// signaling address (best-effort, no DNS lookup). Set only on success (reached_stage == READY).
type ConnectionTransport int32

const (
	ConnectionTransport_CONNECTION_TRANSPORT_UNSPECIFIED ConnectionTransport = 0
	// CONNECTION_TRANSPORT_CLOUD_SIGNALED: signaled through a remote/public signaling server (the cloud app).
	ConnectionTransport_CONNECTION_TRANSPORT_CLOUD_SIGNALED ConnectionTransport = 1
	// CONNECTION_TRANSPORT_MDNS_LOCAL: signaled over an mDNS-discovered local-network path.
	ConnectionTransport_CONNECTION_TRANSPORT_MDNS_LOCAL ConnectionTransport = 2
	// CONNECTION_TRANSPORT_LOCAL: signaled through a loopback/private-address signaling server
	// (e.g. a machine's own signaling server or a self-hosted signaler) without mDNS discovery.
	ConnectionTransport_CONNECTION_TRANSPORT_LOCAL ConnectionTransport = 3
)
...
var (
	ConnectionTransport_name = map[int32]string{
		...
		1: "CONNECTION_TRANSPORT_CLOUD_SIGNALED",
		2: "CONNECTION_TRANSPORT_MDNS_LOCAL",
		3: "CONNECTION_TRANSPORT_LOCAL",
	}
	ConnectionTransport_value = map[string]int32{
		"CONNECTION_TRANSPORT_UNSPECIFIED":    0,
		"CONNECTION_TRANSPORT_CLOUD_SIGNALED": 1,
		"CONNECTION_TRANSPORT_MDNS_LOCAL":     2,
		"CONNECTION_TRANSPORT_LOCAL":          3,
	}
)
...
func (ConnectionTransport) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_rpc_webrtc_v1_signaling_proto_enumTypes[3].Descriptor()
}

func (ConnectionTransport) Type() protoreflect.EnumType {
	return &file_proto_rpc_webrtc_v1_signaling_proto_enumTypes[3]
}
...
type ConnectionCandidate struct {
	...
	Type ICECandidateType `protobuf:"varint,1,opt,name=type,proto3,enum=proto.rpc.webrtc.v1.ICECandidateType" json:"type,omitempty"`
...
func (x *ConnectionCandidate) Reset() {
	*x = ConnectionCandidate{}
	mi := &file_proto_rpc_webrtc_v1_signaling_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConnectionCandidate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectionCandidate) ProtoMessage() {}

func (x *ConnectionCandidate) ProtoReflect() protoreflect.Message {
	mi := &file_proto_rpc_webrtc_v1_signaling_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectionCandidate.ProtoReflect.Descriptor instead.
func (*ConnectionCandidate) Descriptor() ([]byte, []int) {
	return file_proto_rpc_webrtc_v1_signaling_proto_rawDescGZIP(), []int{22}
}

func (x *ConnectionCandidate) GetType() ICECandidateType {
	if x != nil {
		return x.Type
	}
...
func (x *ConnectionCandidate) GetRelayAddress() string {
	if x != nil {
...
type ReportConnectionMetadataRequest struct {
	...
	Local   *ConnectionCandidate `protobuf:"bytes,1,opt,name=local,proto3" json:"local,omitempty"`
	...
	// duration_ms is the wall-clock time from dial start to connection ready (on success) or to the
	// failure (on failure).
	DurationMs uint32 `protobuf:"varint,5,opt,name=duration_ms,json=durationMs,proto3" json:"duration_ms,omitempty"`
	// transport is how a successful connection was established; unset on failure.
	Transport ConnectionTransport `protobuf:"varint,6,opt,name=transport,proto3,enum=proto.rpc.webrtc.v1.ConnectionTransport" json:"transport,omitempty"`
	// failure_code is the gRPC status code name of the dial failure (e.g. "DeadlineExceeded" for a
	// dial timeout, "Unauthenticated", "Unavailable"); set only on failure. A bounded set, suitable
	// as a metric label. Success is inferred from reached_stage == READY, so no outcome field needed.
	FailureCode string `protobuf:"bytes,7,opt,name=failure_code,json=failureCode,proto3" json:"failure_code,omitempty"`
	// sdk_version is the version of the dialing SDK (e.g. a semver or git tag). Reported so failure
	// spikes can be attributed to a specific SDK release. Bounded-ish cardinality (releases in use).
...
func (x *ReportConnectionMetadataRequest) GetLocal() *ConnectionCandidate {
	if x != nil {
		return x.Local
	}
	return nil
...
func (x *ReportConnectionMetadataRequest) GetRemote() *ConnectionCandidate {
	if x != nil {
		return x.Remote
	}
	return nil
...
func (x *ReportConnectionMetadataRequest) GetReachedStage() DialStage {
	if x != nil {
		return x.ReachedStage
	}
	return DialStage_DIAL_STAGE_UNSPECIFIED
}

func (x *ReportConnectionMetadataRequest) GetDurationMs() uint32 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *ReportConnectionMetadataRequest) GetTransport() ConnectionTransport {
	if x != nil {
		return x.Transport
	}
...
func (x *ReportConnectionMetadataRequest) GetFailureCode() string {
	if x != nil {
...
func (x *ReportConnectionMetadataRequest) GetSdkVersion() string {
	if x != nil {
		return x.SdkVersion
	}
	return ""
...
func (x *ReportConnectionMetadataResponse) Reset() {
	*x = ReportConnectionMetadataResponse{}
	mi := &file_proto_rpc_webrtc_v1_signaling_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportConnectionMetadataResponse) Descriptor() ([]byte, []int) {
	return file_proto_rpc_webrtc_v1_signaling_proto_rawDescGZIP(), []int{24}
}
...
var file_proto_rpc_webrtc_v1_signaling_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x31, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2b, 0x22, 0x29, 0x2f, 0x72, 0x70, 0x63, 0x2f, 0x77, 0x65,
	0x62, 0x72, 0x74, 0x63, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x6f, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x70,
	0x63, 0x2f, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_rpc_webrtc_v1_signaling_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_proto_rpc_webrtc_v1_signaling_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_proto_rpc_webrtc_v1_signaling_proto_goTypes = []any{
	...
	(DialStage)(0),                           // 2: proto.rpc.webrtc.v1.DialStage
	(ConnectionTransport)(0),                 // 3: proto.rpc.webrtc.v1.ConnectionTransport
	(*ICECandidate)(nil),                     // 4: proto.rpc.webrtc.v1.ICECandidate
	(*CallRequest)(nil),                      // 5: proto.rpc.webrtc.v1.CallRequest
	(*CallResponseInitStage)(nil),            // 6: proto.rpc.webrtc.v1.CallResponseInitStage
	(*CallResponseUpdateStage)(nil),          // 7: proto.rpc.webrtc.v1.CallResponseUpdateStage
	(*CallResponse)(nil),                     // 8: proto.rpc.webrtc.v1.CallResponse
	(*CallUpdateRequest)(nil),                // 9: proto.rpc.webrtc.v1.CallUpdateRequest
	(*CallUpdateResponse)(nil),               // 10: proto.rpc.webrtc.v1.CallUpdateResponse
	(*ICEServer)(nil),                        // 11: proto.rpc.webrtc.v1.ICEServer
	(*WebRTCConfig)(nil),                     // 12: proto.rpc.webrtc.v1.WebRTCConfig
	(*AnswerRequestInitStage)(nil),           // 13: proto.rpc.webrtc.v1.AnswerRequestInitStage
	(*AnswerRequestUpdateStage)(nil),         // 14: proto.rpc.webrtc.v1.AnswerRequestUpdateStage
	(*AnswerRequestDoneStage)(nil),           // 15: proto.rpc.webrtc.v1.AnswerRequestDoneStage
	(*AnswerRequestErrorStage)(nil),          // 16: proto.rpc.webrtc.v1.AnswerRequestErrorStage
	(*AnswerRequestHeartbeatStage)(nil),      // 17: proto.rpc.webrtc.v1.AnswerRequestHeartbeatStage
	(*AnswerRequest)(nil),                    // 18: proto.rpc.webrtc.v1.AnswerRequest
	(*AnswerResponseInitStage)(nil),          // 19: proto.rpc.webrtc.v1.AnswerResponseInitStage
	(*AnswerResponseUpdateStage)(nil),        // 20: proto.rpc.webrtc.v1.AnswerResponseUpdateStage
	(*AnswerResponseDoneStage)(nil),          // 21: proto.rpc.webrtc.v1.AnswerResponseDoneStage
	(*AnswerResponseErrorStage)(nil),         // 22: proto.rpc.webrtc.v1.AnswerResponseErrorStage
	(*AnswerResponse)(nil),                   // 23: proto.rpc.webrtc.v1.AnswerResponse
	(*OptionalWebRTCConfigRequest)(nil),      // 24: proto.rpc.webrtc.v1.OptionalWebRTCConfigRequest
	(*OptionalWebRTCConfigResponse)(nil),     // 25: proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse
	(*ConnectionCandidate)(nil),              // 26: proto.rpc.webrtc.v1.ConnectionCandidate
	(*ReportConnectionMetadataRequest)(nil),  // 27: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest
	(*ReportConnectionMetadataResponse)(nil), // 28: proto.rpc.webrtc.v1.ReportConnectionMetadataResponse
	(*status.Status)(nil),                    // 29: google.rpc.Status
	(*timestamppb.Timestamp)(nil),            // 30: google.protobuf.Timestamp
}
var file_proto_rpc_webrtc_v1_signaling_proto_depIdxs = []int32{
	4,  // 0: proto.rpc.webrtc.v1.CallResponseUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	6,  // 1: proto.rpc.webrtc.v1.CallResponse.init:type_name -> proto.rpc.webrtc.v1.CallResponseInitStage
	7,  // 2: proto.rpc.webrtc.v1.CallResponse.update:type_name -> proto.rpc.webrtc.v1.CallResponseUpdateStage
	4,  // 3: proto.rpc.webrtc.v1.CallUpdateRequest.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	29, // 4: proto.rpc.webrtc.v1.CallUpdateRequest.error:type_name -> google.rpc.Status
	11, // 5: proto.rpc.webrtc.v1.WebRTCConfig.additional_ice_servers:type_name -> proto.rpc.webrtc.v1.ICEServer
	12, // 6: proto.rpc.webrtc.v1.AnswerRequestInitStage.optional_config:type_name -> proto.rpc.webrtc.v1.WebRTCConfig
	30, // 7: proto.rpc.webrtc.v1.AnswerRequestInitStage.deadline:type_name -> google.protobuf.Timestamp
	4,  // 8: proto.rpc.webrtc.v1.AnswerRequestUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	29, // 9: proto.rpc.webrtc.v1.AnswerRequestErrorStage.status:type_name -> google.rpc.Status
	13, // 10: proto.rpc.webrtc.v1.AnswerRequest.init:type_name -> proto.rpc.webrtc.v1.AnswerRequestInitStage
	14, // 11: proto.rpc.webrtc.v1.AnswerRequest.update:type_name -> proto.rpc.webrtc.v1.AnswerRequestUpdateStage
	15, // 12: proto.rpc.webrtc.v1.AnswerRequest.done:type_name -> proto.rpc.webrtc.v1.AnswerRequestDoneStage
	16, // 13: proto.rpc.webrtc.v1.AnswerRequest.error:type_name -> proto.rpc.webrtc.v1.AnswerRequestErrorStage
	17, // 14: proto.rpc.webrtc.v1.AnswerRequest.heartbeat:type_name -> proto.rpc.webrtc.v1.AnswerRequestHeartbeatStage
	4,  // 15: proto.rpc.webrtc.v1.AnswerResponseUpdateStage.candidate:type_name -> proto.rpc.webrtc.v1.ICECandidate
	29, // 16: proto.rpc.webrtc.v1.AnswerResponseErrorStage.status:type_name -> google.rpc.Status
	19, // 17: proto.rpc.webrtc.v1.AnswerResponse.init:type_name -> proto.rpc.webrtc.v1.AnswerResponseInitStage
	20, // 18: proto.rpc.webrtc.v1.AnswerResponse.update:type_name -> proto.rpc.webrtc.v1.AnswerResponseUpdateStage
	21, // 19: proto.rpc.webrtc.v1.AnswerResponse.done:type_name -> proto.rpc.webrtc.v1.AnswerResponseDoneStage
	22, // 20: proto.rpc.webrtc.v1.AnswerResponse.error:type_name -> proto.rpc.webrtc.v1.AnswerResponseErrorStage
	12, // 21: proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse.config:type_name -> proto.rpc.webrtc.v1.WebRTCConfig
	0,  // 22: proto.rpc.webrtc.v1.ConnectionCandidate.type:type_name -> proto.rpc.webrtc.v1.ICECandidateType
	26, // 23: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.local:type_name -> proto.rpc.webrtc.v1.ConnectionCandidate
	26, // 24: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.remote:type_name -> proto.rpc.webrtc.v1.ConnectionCandidate
	1,  // 25: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.sdk_type:type_name -> proto.rpc.webrtc.v1.SDKType
	2,  // 26: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.reached_stage:type_name -> proto.rpc.webrtc.v1.DialStage
	3,  // 27: proto.rpc.webrtc.v1.ReportConnectionMetadataRequest.transport:type_name -> proto.rpc.webrtc.v1.ConnectionTransport
	5,  // 28: proto.rpc.webrtc.v1.SignalingService.Call:input_type -> proto.rpc.webrtc.v1.CallRequest
	9,  // 29: proto.rpc.webrtc.v1.SignalingService.CallUpdate:input_type -> proto.rpc.webrtc.v1.CallUpdateRequest
	23, // 30: proto.rpc.webrtc.v1.SignalingService.Answer:input_type -> proto.rpc.webrtc.v1.AnswerResponse
	24, // 31: proto.rpc.webrtc.v1.SignalingService.OptionalWebRTCConfig:input_type -> proto.rpc.webrtc.v1.OptionalWebRTCConfigRequest
	27, // 32: proto.rpc.webrtc.v1.SignalingService.ReportConnectionMetadata:input_type -> proto.rpc.webrtc.v1.ReportConnectionMetadataRequest
	8,  // 33: proto.rpc.webrtc.v1.SignalingService.Call:output_type -> proto.rpc.webrtc.v1.CallResponse
	10, // 34: proto.rpc.webrtc.v1.SignalingService.CallUpdate:output_type -> proto.rpc.webrtc.v1.CallUpdateResponse
	18, // 35: proto.rpc.webrtc.v1.SignalingService.Answer:output_type -> proto.rpc.webrtc.v1.AnswerRequest
	25, // 36: proto.rpc.webrtc.v1.SignalingService.OptionalWebRTCConfig:output_type -> proto.rpc.webrtc.v1.OptionalWebRTCConfigResponse
	28, // 37: proto.rpc.webrtc.v1.SignalingService.ReportConnectionMetadata:output_type -> proto.rpc.webrtc.v1.ReportConnectionMetadataResponse
